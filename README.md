...
# Users Microservice
MARKETPLACE_USERS_API=http://wiv-mkt-krakend.westeurope.cloudapp.azure.com:8080/api/users

# Suggestions Microservice
RETRIEVE_RECOMMENDATIONS_URL=http://wiv-mkt-krakend.westeurope.cloudapp.azure.com:8080/api/recommendations
...
# POLYGON_SCAN_TXN_LINK=https://polygonscan.com/tx/
