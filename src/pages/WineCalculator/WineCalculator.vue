  ...
  methods: {
    ...
    calculateFinalWorth(type: string) {
      ...
      switch (type) {
        case 'low':
          this.potentialGain =
            this.investmentPrincipal * 1.08 * (this.investmentAge / 12);
          break;
        case 'medium':
          this.potentialGain =
            this.investmentPrincipal * 2.28 * (this.investmentAge / 12);
          break;
        case 'high':
          this.potentialGain =
						this.investmentPrincipal * 3.55 * (this.investmentAge / 12);
          break;
        default:
