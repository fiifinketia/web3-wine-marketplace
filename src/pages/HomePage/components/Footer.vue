<template>
	<div class="footer-container">
		...
		<div class="flex row justify-between text-left">
			<div class="first">
				<div class="column q-pl-sm q-pt-md">
					<a class="footer-bold-text q-py-sm" :href="nftsUrl">NFTs</a>
					<a class="footer-normal-text q-py-sm" :href="newReleasesUrl"
						>New Releases</a
					>
					<a class="footer-normal-text q-py-sm" :href="recommendedUrl"
						>Recommended</a
					>
					<a class="footer-bold-text q-py-sm" :href="favouritesUrl"
						>Favourites</a
					>
			...
			<div class="third">
				...
				<div class="flex column footer-column q-pt-md">
					...
					<div class="flex row">
						<div class="q-pr-md">
							<q-img src="../../../../public/images/discord.svg" width="20px" />
						</div>
						<div class="q-pr-md">
							<q-img src="../../../../public/images/twitter.svg" width="20px" />
						</div>
						<div class="q-pr-md">
							<q-img
